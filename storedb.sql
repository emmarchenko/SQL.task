...
INSERT categories (name, parent_cat_id)
VALUES
('Одежда',NULL),
('Рубашки',1),
('Джинсы',1),
...
('img\tshr_1.1.webp', 'майка DeFacto'),
('img\tshr_1.2.webp', 'майка DeFacto'),
('img\tshr_2.1.webp', 'майка Envylab'),
('img\tshr_2.2.webp', 'майка Envylab'),
('img\tshr_3.1.webp', 'майка Puma'),
('img\tshr_3.2.webp', 'майка Puma');


INSERT products (name, category_id, image_id, price_wo_disc, price, price_promo, amount, description)
VALUES
('O''stin', 2, 1, 0, 2399, 1999, 2, 'Короткий рукав'),
('Outventure', 2, 3, 0, 1699, 0, 4, 'Короткий рукав'),
('Columbia', 2, 5, 0, 3899, 0, 1, 'Короткий рукав'),
('Northland', 2, 7, 0, 3299, 1649, 5, 'Короткий рукав'),
('Helly Hansen', 2, 9, 0, 7190, 0, 6, 'Длинный рукав'),
('Oakley', 2, 11, 0, 7800, 7410, 7, 'Длинный рукав'),
('DC Shoes', 2, 13, 0, 7190, 0, 5, 'Длинный рукав'),
('Graghoppers', 2, 15, 0, 10999, 4399, 1, 'Длинный рукав'),
('Regatta', 2, 17, 0, 2999, 1319, 5, 'Короткий рукав'),
('Protest', 2, 19, 0, 2899, 1449, 6, 'Короткий рукав'),
('The Nord Face', 2, 21, 0, 9590, 0, 4, 'Длинный рукав'),
('Reebok Classic', 2, 23, 0, 7399, 4510, 8, 'Длинный рукав'),
('Hurley', 2, 25, 0, 5899, 0, 1, 'Длинный рукав'),
('Dali', 3, 27, 0, 4999, 3290, 2, 'Straight fit'),
('Durley', 3, 29, 0, 8999, 5480, 4, 'Slim fit'),
('Quiksilver', 3, 29, 6590, 4280, 3210, 8, 'Regular fit'),
('DeFacto', 4, 31, 0, 1499, 599, 2, 'Sport'),
('Envylab', 4, 33, 0, 1150, 782, 7, 'Sport'),
('Puma', 4, 35, 0, 1990, 0, 4, 'Casual');
